...
import REGIONS_DATA from './REGIONS_DATA.js';

const Map = () => {
    const [hoveredRegionId, setHoveredRegionId] = useState(0)
    const [isPopupVisible, setIsPopupVisible] = useState(false)
    const [cursorPosition, setCurcorPosition] = useState({})

    const getCursor = (e, id) => {
    ...
    return (
        <div className="russian-map-wrap">
            <div className="map-popup" style={popupStyle}>
                {REGIONS_DATA[hoveredRegionId].value}
            </div>
